...
var next_position = Vector2(-1368, 1952)
var distance_from_prot = 0
var damaging = false
var initial_position = Vector2(-1368, 1952)
...
func check_prota():
	var collisions = str(get_parent().get_parent().get_node("Area2D2").get_overlapping_bodies())
...
func be_distracted(delta):
	...
	if time_distracted >= Global.time_for_2:
		distracted = false
		time_distracted = 0
